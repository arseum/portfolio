...
const DICT = {
  fr: {
    ...
    'projects.beta': 'BÊTA',
    'projects.p0.desc': "Application desktop (Mac, Windows, Linux) qui analyse automatiquement les mains Winamax : statistiques détaillées, sessions, replayer de mains, courbes de gains et solver préflop. Conçue et développée en solo — Electron, SQLite, IPC typé, auto-update — actuellement en bêta gratuite.",
  ...
  en: {
    ...
    'projects.beta': 'BETA',
    'projects.p0.desc': 'Desktop app (Mac, Windows, Linux) that automatically analyses Winamax hands: detailed statistics, sessions, hand replayer, profit graphs and a preflop solver. Designed and built solo — Electron, SQLite, typed IPC, auto-update — currently in free beta.',
